...
```yaml
role:        Founder & CTO @ Botshala | B.Tech CSE Student
university:  IPS Academy, IES Indore  (CGPA: 8.4/10 | 2022 - 2026)
focus:       Computer Vision · Deep Learning · Embedded AI · Robotics
building:    ARJUNA AI — software-only surveillance system (🏆 MSME shortlisted, ₹15L funding)
currently:   Def-Space Intern @ BSERC — Viksit Bharat Abhiyan @2047
```
...
> Also working with: **YOLOv8**, **MediaPipe**, **BERT/Transformers**, **CNN/LSTM**, **Pose Estimation**, **Streamlit**, **Pandas/NumPy** — not yet in the icon set above but core to daily work.
...
### 🛡️ [ARJUNA AI](https://github.com/sahilsharmaverse/Arjuna)
**Smart Surveillance Platform**
🏆 MSME Shortlisted — ₹15L Funding
...
### 🤟 [Sign-Link](https://github.com/sahilsharmaverse/Signlink)
**Indian Sign Language Translator**
🏆 IPS Academy Research Grant
...
```
2026 ─┬─ Def-Space Summer Intern · BSERC
      │  Generative AI · Cybersecurity · Drone & Rocketry Design · EV/Robotics
      │  (Viksit Bharat Abhiyan @2047 initiative)
      │
2025 ─┼─ Founder & CTO · Botshala
      │  AI & Robotics education startup | 500+ students trained
      │  Full-stack: FastAPI + React + AWS
      │  Built India's first Scratch/mBlock alternative w/ AI mentor
      │
2024 ─┴─ Robotics & Embedded Systems Intern · Youngovator Education Pvt. Ltd.
         PID-based autonomous robot — 🌍 7th Globally, Technoxian 2024
         Trained 200+ students in AI, IoT & 3D modeling
```
...
| Title | Venue | Year |
|---|---|---|
| UPI-Based Financial Fraud Detection using Deep Learning | IEEE · ACROSET International Conference | 2024 |
| An Empirical Study of Technophobia among Adults | Journal of Propulsion Technology (ISSN: 1001-4055) | 2024 |
| The Power of NLP: Techniques, Tools & Real-World Applications | Indian Journal of Natural Sciences, Vol. 16, Issue 92 | 2025 |
| *Computer System Organization* — Book Contributor (visuals & editing) | Ane Books Pvt. Ltd. | 2024 |
...
**Achievements**
- 🥇 Swaranjali Award 2026
- 🥇 Winner, Circuit Craft 2025
- 🌍 7th Globally, Technoxian Robotics 2024
- 🥈 5th, IIT Indore Fluxus 2024
- 🥉 3rd, RGPV Rifle Championship 2022

</td>
<td valign="top" width="50%">

**Leadership & Certifications**
- 👨‍💼 Managing Head, B.Tech Induction 2025
- 🤖 Core Member, Robotics Club
- ⛓️ Tech Team, Archway IPSA (Blockchain Club)
- 📜 ML Workshop — IIT Bombay & AWS
- 📜 Generative AI · ACROSET 2024 · IGNITE 2021 (SRM IST)
...
```
"Building tech that sees, understands, and helps — from surveillance AI 
 to sign-language translation to XR simulations."
```

⭐️ **From** [`sahilsharmaverse`](https://github.com/sahilsharmaverse)
